...
Online models  split the data into train by taking first 744 hours (1 month) and test by taking the rest of the data, and use a baseline windnow of length 744 sliding window of length 1 hour to find anomalies in the test data.
